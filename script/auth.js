    ...
    <h2>sign in</h2>
     <button class="btn-close"></button> </div> 
      <div class="flex-column"> <label>Email </label> </div> <div class="inputForm"> <i class="fa-solid fa-at"></i>
       <input name="email" min="6" type="text" class="input" placeholder="Enter your Email" /> </div> <div class="mailMsg Error_msg">Please Enter a valid email !</div> <div class="flex-column"> <label>Password </label> </div> <div class="inputForm"> <i class="fa-solid fa-lock"></i> <input
 name="password"
 type="password"
 class="input"
 placeholder="Enter your Password"
